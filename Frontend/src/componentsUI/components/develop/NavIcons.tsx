...
import {
  selectLastUnreadNotifications,
  selectTotalPendingNotifications,
...
export default function NavIcons(user: { user: User }) {
  ...
  const TotalPendingChats = useSelector((state: RootState) =>
    selectTotalPendingChats(state)
  );
  const [showNotifications, setShowNotifications] = useState(false);
  const notifications = useSelector((state: RootState) =>
    selectLastUnreadNotifications(state)
  );
